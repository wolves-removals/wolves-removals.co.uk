...
def build_index(posts):
    ...
    sidebar = (
        ...
        f'<input type="text" name="first_name" placeholder="Your Name" aria-label="Your name" class="{_ipt}" required>'
        f'<input type="email" name="email" placeholder="Your Email" aria-label="Your email address" class="{_ipt}" required>'
        f'<input type="tel" name="phone" placeholder="Your Phone" aria-label="Your phone number" class="{_ipt}">'
        f'<input type="text" name="enquiry" placeholder="Best time to call back" aria-label="Best time to call back" class="{_ipt}">'
