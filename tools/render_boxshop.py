...
def _basket():
    ...
    return (
        ...
        f'<input type="text" name="name" placeholder="Your Name" aria-label="Your name" required class="{ipt}">'
        f'<input type="email" name="email" placeholder="Your Email" aria-label="Your email address" required class="{ipt}">'
        f'<input type="tel" name="phone" placeholder="Your Phone" aria-label="Your phone number" class="{ipt}">'
        f'<select name="fulfilment" aria-label="Collection or delivery" class="{ipt}"><option value="Collection">Collection from us (free)</option>'
        '<option value="Delivery">Delivery (free over &pound;75 in Sussex)</option></select>'
        f'<textarea name="address" rows="2" placeholder="Delivery address (if delivering)" aria-label="Delivery address" class="{ipt}"></textarea>'
        f'<textarea name="notes" rows="2" placeholder="Anything else? (move date, etc.)" aria-label="Order notes" class="{ipt}"></textarea>'
